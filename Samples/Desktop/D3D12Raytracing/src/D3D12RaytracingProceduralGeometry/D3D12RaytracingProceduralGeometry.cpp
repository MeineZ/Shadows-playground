...
void D3D12RaytracingProceduralGeometry::InitializeScene()
{
	...
	// Setup lights. 
	{
		...
		lightPosition = XMFLOAT4(8.05484772, 18.0000000, 18.3062706, 1.0f);
...
void D3D12RaytracingProceduralGeometry::BuildPlaneGeometry()
{
	...
	Vertex vertices[] =
	{
		...
		{ XMFLOAT3(0.25f, 0.7f, 0.5f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.5f,  3.0f, 0.5f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.75f, 0.7f, 0.5f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
...
void D3D12RaytracingProceduralGeometry::BuildBotomLevelASInstanceDescs(BLASPtrType *bottomLevelASaddresses, ComPtr<ID3D12Resource>* instanceDescsResource)
{
	...
	const XMUINT3 NUM_AABB = XMUINT3(5, 1, 5);
...
void D3D12RaytracingProceduralGeometry::OnUpdate()
{
	...
	if (m_animateLight)
	{
		...
		const XMVECTOR& newLightPosition = XMVector3Transform(prevLightPosition, rotate);
		m_sceneCB->lightPosition = newLightPosition;
	}
